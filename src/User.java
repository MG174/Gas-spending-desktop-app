...
public class User extends javax.swing.JFrame {
    ...
    public void loader(){
        for (int i = 0; i < bundleGarage.getListaGarage().size(); i++) {
            jComboBox1.addItem(bundleGarage.getListaGarage().get(i));
        }
    }
    ...
    private void initComponents() {
        ...
        jComboBox1 = new javax.swing.JComboBox<Garage>();
        ...
        jLabel1.setText("Witaj! Wybierz użytkownika:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        newuser.setBundleGarage(bundleGarage);
        dispose();
    ...
    private javax.swing.JComboBox<Garage> jComboBox1;
